...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\CompositionType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CompositionType']) ? $this->services['AppBundle\Form\CompositionType'] : $this->services['AppBundle\Form\CompositionType'] = new \AppBundle\Form\CompositionType()) && false ?: '_'};
}, 'AppBundle\\Form\\IngredientsType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\IngredientsType']) ? $this->services['AppBundle\Form\IngredientsType'] : $this->services['AppBundle\Form\IngredientsType'] = new \AppBundle\Form\IngredientsType()) && false ?: '_'};
}, 'AppBundle\\Form\\RecettesType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\RecettesType']) ? $this->services['AppBundle\Form\RecettesType'] : $this->services['AppBundle\Form\RecettesType'] = new \AppBundle\Form\RecettesType()) && false ?: '_'};
