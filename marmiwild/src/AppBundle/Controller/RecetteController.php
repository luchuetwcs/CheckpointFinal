...
class RecetteController extends Controller
{
    ...
    /**
     * @Route("/search/{titre}", name="ajaxRechercheAction")
     * @Method("GET")
     * @param SerializerInterface $serializer
     * @param $titre
     * @return Response
     */
    public function ajaxRechercheAction(SerializerInterface $serializer,$titre){

        $em=$this->getDoctrine()->getManager();
        $recettes = $em->getRepository('AppBundle:Recette')->findRecetteByTitre($titre);
        $data=$serializer->serialize($recettes, 'json');
