...
class IngredientController extends Controller
{
     ...
     *
     * @Route("/{id}", name="ingredient_index")
     * @Method("GET")
     */
    public function indexAction(Recipe $recipe)
    {
        ...
        $ingredients = $em->getRepository('AppBundle:Ingredient')->findBy(["recipes" => $recipe_id]);
     ...
     *
     * @Route("/{id}/new", name="ingredient_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request, Recipe $recipe)
    {
        ...
        $ingredient->setRecipes($recipe->getId());
        $recipe_id = $recipe->getId();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('ingredient_index', array('id' => $ingredient->getRecipes()));
        }
    ...
    public function editAction(Request $request, Ingredient $ingredient)
    {
        ...
        $recipe_id = $ingredient->getRecipes();
